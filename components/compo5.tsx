...
export default function Compo5() {
    ...
    return (
        <section id="compo4" className="snap-start relative min-h-[100dvh] w-full flex items-center justify-center bg-zinc-950 border-t border-[#222] px-4 py-14 overflow-hidden text-white sm:px-6 sm:py-20">
