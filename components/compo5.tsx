...
export default function Compo5() {
    ...
    return (
        <>
            <section id="hackathon-turnout" className="snap-start relative min-h-[100dvh] w-full flex flex-col items-center justify-center bg-[#111] border-t border-[#222] px-4 py-8 sm:px-6 lg:h-[100dvh]">
