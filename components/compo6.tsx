...
export default function Compo6() {
    ...
    return (
        <section id="hackathon-winner" className="snap-start relative min-h-[100dvh] w-full flex items-center justify-center bg-zinc-950 border-t border-[#222] px-4 py-8 overflow-hidden text-white sm:px-6 sm:py-10 lg:h-[100dvh]">
